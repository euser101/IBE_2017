...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Mai 2017 um 15:54
...
CREATE TABLE IF NOT EXISTS `tbl_bild` (
  ...
  `FK_Hotel` int(11) NOT NULL,
  PRIMARY KEY (`PK_Bild`),
  KEY `fk_tbl_bild_tbl_hotel1_idx` (`FK_Hotel`)
...
(2, 'img/Hotels/Deutschland/1_hotel_berlin_alexanderplatz/h1_b1.jpg', 5),
(3, 'img/Hotels/Deutschland/4_azimut_hotel_cologne_city_center/h4_b1.jpg', 6),
(4, 'img\\Hotels\\Schweiz\\1_baur_au_lac\\h1_b1.jpg', 1),
(5, 'img\\Hotels\\Schweiz\\1_baur_au_lac\\h1_b1.jpg', 9);
...
--
-- Constraints der Tabelle `tbl_bild`
--
